...
public class PointCPTest
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("Polar to Cartesian Coordinates Conversion Program");
    ...
    try
    {
      point = new PointCP(Double.valueOf(args[1]).doubleValue(), Double.valueOf(args[2]).doubleValue());
    }
    catch(Exception e)
    {
  ...
  private static PointCP getInput() throws IOException
  {
    ...
    char coordType = 'P'; // coordType default set to P
    double a = 0.0;
    double b = 0.0;
